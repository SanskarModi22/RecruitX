...
class EmployeerAccountScreen extends StatefulWidget {
  // const EmployeerAccountScreen({ Key? key }) : super(key: key);
  static const routeName = '/EmployeerAccountScreen';

  @override
  _EmployeerAccountScreenState createState() => _EmployeerAccountScreenState();
}

class _EmployeerAccountScreenState extends State<EmployeerAccountScreen> {
